...
Here’s a minimal Java example that retrieves every page from a Confluence space and stores the results as individual JSON files:
...
Big documents don’t embed well.
...
This becomes your “source library”. 
...
👉 [https://www.kaggle.com/datasets/sircausticmail/all-minilm-l6-v2zip](https://www.kaggle.com/datasets/sircausticmail/all-minilm-l6-v2zip)
...
Now we have the chunks that are semantically closest to the user’s question.
...
This prompt gives the LLM the exact pieces of information it needs to answer the user’s question — without hallucination and without relying on its general training.
...
Pick one space, one folder, or one project — and build your own AI assistant around it.
